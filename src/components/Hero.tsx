...
const Hero = ({ onNavigate }: HeroProps) => {
  ...
  return (
    <section id="home" className="w-full min-h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col container mx-auto px-6 md:px-12 relative z-10 pt-8">
        <motion.div
        ...
        >
          ...
          <div className="mt-6 inline-flex items-center gap-2 px-4 py-2 border border-border rounded-full text-sm font-semibold text-foreground w-fit">
