          ...
          >
            ...
            <div className="space-y-3 text-muted-foreground text-sm">
              <p className="leading-relaxed">
                I am originally from <span className="text-primary font-semibold">Champawat, Uttarakhand</span>, and currently pursuing my B.Tech in Computer Science and Engineering at Graphic Era Hill University.
              </p>
              <p className="leading-relaxed">
                I am passionate about technology, problem-solving, and exploring modern tools in software development. I focus on building practical projects, learning new technologies, and continuously improving my skills as a developer.
              </p>
            </div>
          </motion.div>
        </div>
